...
const Konkursy = (function () {
    ...
    function buildControls() {
        ...
        renderDock('dock-' + mode,
            ...
            '<button id="btn-pour-comp" onclick="launchPour(\'comp\')" class="w-full bg-amber-700 hover:bg-amber-800 text-white font-bold py-3.5 px-4 rounded-lg shadow text-base md:text-lg active:scale-95 transition-transform disabled:opacity-50 disabled:cursor-not-allowed">' +
